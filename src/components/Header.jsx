...
function Header() {
  return (
    <>
      ...
      <nav className="grid grid-cols-3 items-center bg-[#0C0D0F] w-full h-16 max-w-5xl border border-white/5 rounded-full px-4 md:px-8 py-3 shadow-2xl">

        <div className="flex items-center justify-start">
          <span className="text-lg font-bold tracking-tight text-white">jcrtv<span className="text-white/40">.dev</span></span>
        </div>

        <div className="flex items-center justify-center gap-3 md:gap-6 text-xs md:text-sm font-medium">
